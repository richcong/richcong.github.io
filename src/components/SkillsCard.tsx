import { Box, Divider, FormLabel, Stack } from "@mui/joy";
...
export default function SkillsCard({ skillsRef }: SkillsCardProps) {
  return (
    <>
      {/* Computer view --------------------------------------------------------- */}
      <Card sx={{ m: 0, display: { xs: "none", md: "flex" } }} color="primary">
        <Box ref={skillsRef} sx={{ mb: 1 }}>
      ...
      {/* Mobile view --------------------------------------------------------- */}
      <Card sx={{ m: 0, display: { xs: "flex", md: "none" } }} color="primary">
        <Box ref={skillsRef} sx={{ mb: 1 }}>
          <Typography level="title-md">Skills</Typography>
          <Typography level="body-sm">My tech stack</Typography>
        </Box>
